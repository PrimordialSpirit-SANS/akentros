...
export interface AkentrosQueryResult {
  rows?: unknown[];
}

export type AkentrosQueryFn = (sql: string, params?: unknown[]) => Promise<AkentrosQueryResult>;
...
// 對外回傳值一律以明確介面呈現。
export function akentrosQueryRows(result: AkentrosQueryResult | null | undefined): any[] {
